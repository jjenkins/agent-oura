...
- [x] Natural-language queries against Oura data (e.g., "how did I sleep this week?") — Validated in Phase 03: queries-and-extended-data
- [x] Support for all major Oura API v2 endpoints (sleep, activity, readiness, heart rate, SpO2, stress, workouts, sessions, tags) — Validated in Phase 03: queries-and-extended-data
